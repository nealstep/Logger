...
void loop(void) {
    ...
    lg.value("one", 1);
    lg.value("str1", "this");
    lg.value("8", (uint8_t)(1 << 7));
    lg.value("16", (uint16_t)(1U << 15));
    lg.value("32", (uint32_t)(1UL << 31));
    lg.value("64", (uint64_t)(1ULL << 63));
    lg.valued("f", 3.1415);
    lg.valuei("gi", -21);
    lg.valued("gd", -21);
    ...
    lg.report("two", 2);
    lg.report("str2", "that");
    lg.report("8", (uint8_t)(1 << 7));
    lg.report("16", (uint16_t)(1U << 15));
    lg.report("32", (uint32_t)(1UL << 31));
    lg.report("64", (uint64_t)(1ULL << 63));
    lg.reportd("f", 3.1415);
    lg.reporti("gi", -21);
    lg.reportd("gd", -21);
    if (ll_ind  == LL_LEN) {
